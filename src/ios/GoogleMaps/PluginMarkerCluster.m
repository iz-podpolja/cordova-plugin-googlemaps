              ...
              @synchronized (self.pluginMarkers) {
                if (successed) {
                  ...
                  if (image != nil) {
                    ...
                    [createResult setObject:[NSNumber numberWithInt: marker.icon.size.width] forKey:@"width"];
                    [createResult setObject:[NSNumber numberWithInt: marker.icon.size.height] forKey:@"height"];
                  } else {
